        ...
        $this->connection->callableConsistency(CouchbaseN1qlQuery::REQUEST_PLUS,
            function (\Ytake\LaravelCouchbase\Database\CouchbaseConnection $con) {
                \Closure::bind(function () {
                   \PHPUnit\Framework\Assert::assertSame(CouchbaseN1qlQuery::REQUEST_PLUS, $this->consistency);
                }, $con, get_class($con))->__invoke();
            }
        );
        \Closure::bind(function () {
            \PHPUnit\Framework\Assert::assertSame(CouchbaseN1qlQuery::NOT_BOUNDED, $this->consistency);
